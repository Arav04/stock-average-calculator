...
if st.button("📊 Calculate"):
    ...
    st.success(f"✅ You need to buy **{result}** more shares at **${P2}** to reach an average price of **${Pt}**.")

st.markdown("---")
st.write("Developed by **Your Name** | 💡 [GitHub](https://github.com/yourprofile)")
